...
public class SWRLBuiltInLibraryImpl extends AbstractSWRLBuiltInLibrary
{
    ...
    throws SWRLBuiltInException
  {
    ...
    BigDecimal left = argument1.subtract(argument2).abs();
    BigDecimal right = argument2.multiply(tol).abs();
    ...
    throws SWRLBuiltInException
  {
    ...
    if (builtInName.equalsIgnoreCase(SWRLB_ADD)) {
      ...
      BigDecimal argument2 = getArgumentAsADecimal(1, arguments);
      BigDecimal argument3 = getArgumentAsADecimal(2, arguments);
      operationResult =  new BigDecimal(String.valueOf(argument2.divide(argument3, 4, BigDecimal.ROUND_HALF_UP)));
      ...
      BigDecimal argument3 = getArgumentAsADecimal(2, arguments);
      BigDecimal argument2 = getArgumentAsADecimal(1, arguments);
      operationResult =  new BigDecimal(String.valueOf(Math.pow(argument2.doubleValue(),argument3.doubleValue()))).setScale(4, RoundingMode.HALF_UP);
